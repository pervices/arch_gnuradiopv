...
sha512sums=('02722532e614d88ee736f39a2cd4339434f9b4b21a5111a3dfc9b9b4b8ec1149ccaa509af323ba5c35409430c76fcb1244c26403e93e169b121e8cbe6a8a2022'
            'SKIP'
            ...
            '140c937b27d7ac20e3adac7e39267015837ae0ba516d80d34a394e1a526d7a75be61ca6f5479b5307b5f1840a747e81686b54117dbd6d079faa841f3c9ad9adf')
b2sums=('b07391a3fb5dc28e0ae5a9bcb10c3f6fdd35a4e681f9b53a86b24f7a69297cd15a93411210d4aea300bd498bc41a57bc87da1559d672024c7f33010744fb27d0'
        'SKIP'
        ...
        '3d48c2bb49238c203a613adf048fedaa3be449bcd94e1ed3ab89a68f6de9168188fbdb972b276e70a789f11acb08912676c189c92bcf97cfe00d385b27776947')

prepare() {
 patch -d $pkgbase-$pkgver -Rp1 < 7c87800f.patch # Revert change that breaks intalling data
 patch -d $pkgbase-$pkgver -p1 < fmt-10.patch # Fix build with fmt 10
}
