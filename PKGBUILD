...
package_gnuradiopv() {
  ...
  # Also has gnuradio-companion and python-gnuradio since upstream has them as separate packages but we install them as one for backwards compatibility with our old packaging method
  provides+=(${pkgname/gnuradiopv/gnuradio} gnuradio-companion python-gnuradio)
  conflicts=(${pkgname/gnuradiopv/gnuradio} gnuradio-companion python-gnuradio)
  ...
  # Install gnuradio companion. Upstream has this in a separate gnuradio-companion package but we want it installed with gnuradio for backwards compatibility with our old packaging method
  ...
  cd "$pkgdir"
  # Move files to their respective package directories. Upstream also has gnuradio-companion and python-gnuradio packages
  # but we install them both as a part of gnuradio for backwards compatibility with our old packaging method, so those two have been removed.
